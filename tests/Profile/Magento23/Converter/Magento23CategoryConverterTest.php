...
class Magento23CategoryConverterTest extends TestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->categoryConverter = new Magento23CategoryConverter($mappingService, $this->loggingService, $mediaFileService);
    }
