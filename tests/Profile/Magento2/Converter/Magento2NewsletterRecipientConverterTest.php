...
class Magento2NewsletterRecipientConverterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->migrationContext = new MigrationContext($this->connection, new Magento23Profile(), null, new NewsletterRecipientDataSet(), $this->runId, 0, 250);
    }
    ...
    public function testConvertWithInvalidSalesChannel(): void
    {
        ...
        static::assertArrayNotHasKey('salesChannelId', $convertResult->getConverted());
    }
}
