...
class Magento2ProductMultiSelectPropertyRelationConverterTest extends TestCase
{
    ...
    private Magento23ProductMultiSelectPropertyRelationConverter $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->migrationContext = new MigrationContext($this->connection, new Magento23Profile(), null, new ProductMultiSelectPropertyRelationDataSet(), $this->runId, 0, 250);
