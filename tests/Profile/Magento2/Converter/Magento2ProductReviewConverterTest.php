...
class Magento2ProductReviewConverterTest extends TestCase
{
    private Magento23ProductReviewConverter $productReviewConverter;
    ...
    protected function setUp(): void
    {
        ...
        $this->productReviewConverter = new Magento23ProductReviewConverter($this->mappingService, $this->loggingService);
        ...
        $this->migrationContext = new MigrationContext($this->connection, new Magento23Profile(), null, new ProductReviewDataSet(), $this->runId, 0, 250);
