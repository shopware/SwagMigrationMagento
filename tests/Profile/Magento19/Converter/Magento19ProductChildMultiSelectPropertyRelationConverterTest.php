...
class Magento19ProductChildMultiSelectPropertyRelationConverterTest extends TestCase
{
    ...
    private Magento19ProductChildMultiSelectPropertyRelationConverter $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->migrationContext = new MigrationContext($this->connection, new Magento19Profile(), null, new ProductChildMultiSelectPropertyRelationDataSet(), $this->runId, 0, 250);
