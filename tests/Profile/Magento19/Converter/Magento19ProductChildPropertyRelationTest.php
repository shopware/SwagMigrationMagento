...
class Magento19ProductChildPropertyRelationTest extends TestCase
{
    ...
    private Magento19ProductChildPropertyRelationConverter $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->migrationContext = new MigrationContext($this->connection, new Magento19Profile(), null, new ProductChildPropertyRelationDataSet(), $this->runId, 0, 250);
