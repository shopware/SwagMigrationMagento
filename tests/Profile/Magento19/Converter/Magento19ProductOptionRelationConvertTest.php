...
class Magento19ProductOptionRelationConvertTest extends TestCase
{
    ...
    private Magento19ProductOptionRelationConverter $converter;
    ...
    protected function setUp(): void
    {
        ...
        $this->migrationContext = new MigrationContext($this->connection, new Magento19Profile(), null, new ProductOptionRelationDataSet(), $this->runId, 0, 250);
